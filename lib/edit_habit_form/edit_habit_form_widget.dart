...
import 'edit_habit_form_model.dart';
export 'edit_habit_form_model.dart';

class EditHabitFormWidget extends StatefulWidget {
  const EditHabitFormWidget({
    super.key,
...
class _EditHabitFormWidgetState extends State<EditHabitFormWidget> {
  late EditHabitFormModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditHabitFormModel());

    _model.textController1 ??= TextEditingController(text: widget!.habitName);
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.textController2 ??= TextEditingController(text: widget!.habitDesc);
