...
abstract class FlutterFlowTheme {
  ...
  late Color eightyPercent;
  late Color sixtyPercent;
  late Color fourtyPercent;
  late Color twentyPercent;
  late Color tenPercent;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF1A69FF);
  late Color secondary = const Color(0xFF0DA3FF);
  late Color tertiary = const Color(0xFF4187FF);
  late Color alternate = const Color(0xFF00486F);
  ...
  late Color primary600 = Color(0xFF00486F);
  late Color eightyPercent = Color(0xFF4485FF);
  late Color sixtyPercent = Color(0xFF6A9DFD);
  late Color fourtyPercent = Color(0xFF91B4FD);
  late Color twentyPercent = Color(0xFFBFD3FF);
  late Color tenPercent = Color(0xFFD8E3FA);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary600 = Color(0xFF00486F);
  late Color eightyPercent = Color(0xFF4485FF);
  late Color sixtyPercent = Color(0xFF699BF9);
  late Color fourtyPercent = Color(0xFF91B4FD);
  late Color twentyPercent = Color(0xFFBFD3FF);
  late Color tenPercent = Color(0xFFA2A7EF);
}
