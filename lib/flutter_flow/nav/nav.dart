        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'habitForm',
              path: 'habitForm',
              builder: (context, params) => HabitFormWidget(),
            ),
            FFRoute(
              name: 'editHabitForm',
              path: 'editHabitForm',
              builder: (context, params) => EditHabitFormWidget(
                habitRef: params.getParam(
                  'habitRef',
                ...
                habitDesc: params.getParam(
                  'habitDesc',
                  ParamType.String,
                ),
                habitRepeat: params.getParam<String>(
                  'habitRepeat',
                  ParamType.String,
                  isList: true,
                ),
          ...
          final child = appStateNotifier.loading
              ? isWeb
                  ...
                  : Container(
                      ...
                      child: Image.asset(
                        'assets/images/loading_screen_dark.png',
                        fit: BoxFit.cover,
                      ),
                    )
              : page;
