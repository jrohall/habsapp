...
import 'plans_page_model.dart';
export 'plans_page_model.dart';
...
class _PlansPageWidgetState extends State<PlansPageWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlansPageModel());
                                  ...
                                  if (isWeb) {
                                    await showDialog(
                                      ...
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          title: Text(
                                              'Purchase Unavailable on Web'),
                                          content: Text(
                                              'Please access your mobile account to purchase premium.'),
                                          actions: [
                                            TextButton(
                                      ...
                                      await showDialog(
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            ...
                                            content: Text(
                                                'Transaction unsuccessful! Please try again and inspect payment information.'),
                                            actions: [
                                              TextButton(
                                                onPressed: () => Navigator.pop(
                                                    alertDialogContext),
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  12.0, 0.0, 24.0, 0.0),
                              child: Text(
                                'User can create up to 4 habits.',
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                                      fontFamily: FlutterFlowTheme.of(context)
                                    ...
                                    await showDialog(
                                      ...
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          ...
                                          content: Text(
                                              'Please view profile for more information.'),
                                          actions: [
                                            TextButton(
                                              onPressed: () => Navigator.pop(
                                                  alertDialogContext),
